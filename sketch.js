...
function preload(){
  cow =   loadImage("assets/cow-removebg-preview.png");
  jungleImage = loadImage("assets/bg.png");
  shrub1 = loadImage("assets/chapati.jpg");
  shrub2 = loadImage("assets/banana.jpg");
  shrub3 = loadImage("assets/spinach.jpg");
  obstacle1 = loadImage("assets/yawning-lion-removebg-preview.png");
...
function setup() {
  ...
  cow = createSprite(50,200,20,50);
  cow.addImage("cow",cow)
